...
public class SellerOrderAdapter  extends ArrayAdapter<HouseOrderEntity> {

    private int resourceId ;

    public SellerOrderAdapter(Context context, int textViewResourceId, List<HouseOrderEntity> orderEntities){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.housename = view.findViewById(R.id.seller_list_housename);
            viewHolder.orderdate = view.findViewById(R.id.seller_list_orderdate);
            viewHolder.address = view.findViewById(R.id.seller_list_address);
            viewHolder.buyername = view.findViewById(R.id.seller_list_name);
            viewHolder.buyerphone = view.findViewById(R.id.seller_list_phone);
            viewHolder.price = view.findViewById(R.id.seller_list_price);
            viewHolder.orderday = view.findViewById(R.id.seller_list_orderday);
            viewHolder.orderstatu = view.findViewById(R.id.seller_list_orderstatu);
            viewHolder.cancle = view.findViewById(R.id.seller_list_cancel);
        ...
        viewHolder.buyername.setText(orderEntity.getSellername());
                    ...
                    public void run() {
                        OkHttpUtils.post().url(Variable.host+"/updateHouseOrder").addParams("orderid",orderEntity.getOrderid()+"")
                            ...
                            public void onResponse(Object response) {
                                Toast.makeText(getContext(),"已完成交易",Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }).start();
